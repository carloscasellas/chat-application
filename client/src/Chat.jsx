...
export default function Chat() {
    ...
    function handleMessage(event) {
        ...
        if('online' in messageData) {
            ...
            if(messageData.sender === selectedUserId) setMessages(prev => ([...prev, {...messageData}]))
        }
    }
            ...
            <div className="flex flex-col bg-blue-50 w-2/3 p-2">
                ...
                {!!selectedUserId && (
                    <form className="flex gap-2" onSubmit={sendMessage}>
                        ...
                        <label type="button" className="bg-blue-200 text-gray-600 cursor-pointer p-2 rounded-sm border border-blue-200">
